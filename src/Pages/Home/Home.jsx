...
function Home() {
  ...
  <div className="feedback-list">
    <div className="feedback-card">
      <p>📚 "Great collection of books and smooth checkout experience!"</p>
      <span className="feedback-date">Tanya Jhaveri       — 01 May 2025</span>
    </div>
    <div className="feedback-card">
      <p>⭐ "Loved the discounts on bestsellers. Will shop again!"</p>
      <span className="feedback-date">Aangi Shah          — 28 Apr 2025</span>
    </div>
    <div className="feedback-card">
      <p>🚚 "Fast delivery and well-packaged books. Impressed!"</p>
      <span className="feedback-date">Rajvi Khatri        — 25 Apr 2025</span>
    </div>
    <div className="feedback-card">
      <p>💬 "Would love to see more Indian authors featured."</p>
      <span className="feedback-date">Rahul shah          — 20 Apr 2025</span>
    </div>
  </div>
</div>
      <Footer/>
